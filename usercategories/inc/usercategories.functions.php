<?php
/**
 * Filename: usercategories.functions.php
...
/* 	if (!empty($chosen) && is_array($chosen)) {
		$chosen = explode(',', $chosen); // строка 222
	} */
 ...
 * @return string
 */
function cot_usercategories_selectcat2($check, $name, $subcat = '', $hideprivate = true)
{
    ...
    // Перебираем все категории в разделе 'usercategories'
    foreach ($structure['usercategories'] as $i => $x) {
...
/* 
 * Название и описание категории в списках пользователей
 */
